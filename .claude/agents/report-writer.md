...
- Save output to `reports/YYYY-MM-DD-{slug}-report.md` — directly inside `reports/`, NOT inside any subfolder
- Correct: `reports/2026-03-10-career-pivot-app-report.md`
- Wrong: `reports/2026-03-10-career-pivot-app/report.md`
